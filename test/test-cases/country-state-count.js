test("Country/State Count - # of American states", function() {
  $("*[name='country']").find("option[code='US']").attr("selected", "selected").trigger("change");
...
test("Country/State Count - # of Canadian provinces and territories", function() {
  $("*[name='country']").find("option[code='CA']").attr("selected", "selected").trigger("change");
...
test("Country/State Count - # of Indian states and territories", function() {
  $("*[name='country']").find("option[code='IN']").attr("selected", "selected").trigger("change");
...
test("Country/State Count - # of Malaysian states", function() {
  $("*[name='country']").find("option[code='MY']").attr("selected", "selected").trigger("change");
  ok($("*[name='state'] option").length == 16, "There should be 16 Malaysian states");
});

test("Country/State Count - # of Bruneian states", function() {
  $("*[name='country']").find("option[code='BN']").attr("selected", "selected").trigger("change");
...
test("Country/State Count - # of Singaporean districts", function() {
  $("*[name='country']").find("option[code='SG']").attr("selected", "selected").trigger("change");
...
test("Country/State Count - # of regions in Antarctica", function() {
  $("*[name='country']").find("option[code='AQ']").attr("selected", "selected").trigger("change");
